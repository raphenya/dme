                        ...
                        for hsp in alignment.hsps:
                            ...
                            if predicted_genes_dict_protein:
                                if orfInfo.strip() in predicted_genes_dict_protein.keys():
                                    ...
                                    orf_protein_sequence = predicted_genes_dict_protein[orfInfo.decode()[
                                        :orfInfo.decode().index(' # ')]].strip("*")
                            ...
                            try:
                                if card_sequence.upper() == orf_protein_sequence.upper():
                                    ...
                                    ppinsidedict["sequence_from_hmdm"] = json_data[modelID]["model_sequences"][
                                        "sequence"][seqinModel]["protein_sequence"]["sequence"]
                                    ppinsidedict["dna_sequence_from_hmdm"] = json_data[modelID][
                                    ...
                                    if self.input_type == 'contig':
                                        ...
                                        ppinsidedict["orf_end"] = self.extract_nth_hash(
                                            orfInfo.decode(), 2)
                                        ppinsidedict["orf_from"] = self.extract_nth_hash(
                                    ...
                                    insidedict["sequence_from_hmdm"] = json_data[modelID]["model_sequences"][
                                        "sequence"][seqinModel]["protein_sequence"]["sequence"]
                                    insidedict["dna_sequence_from_hmdm"] = json_data[modelID][
                                        "model_sequences"]["sequence"][seqinModel]["dna_sequence"]["sequence"]
                                    if "partial" in json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"].keys():
                                    ...
                                    if self.input_type == 'contig':
                                        ...
                                        insidedict["orf_end"] = self.extract_nth_hash(
                                            orfInfo.decode(), 2)
                                        insidedict["orf_from"] = self.extract_nth_hash(
                                            orfInfo.decode(), 0).rstrip()
                                    ...
                                    linsidedict["orf_end"] = self.extract_nth_bar(
                                        orfInfo.decode(), 2)
                                    linsidedict["orf_from"] = orffrom.decode(
                                    ).strip()
                                    ...
                                    linsidedict["sequence_from_hmdm"] = json_data[modelID]["model_sequences"][
                                        "sequence"][seqinModel]["protein_sequence"]["sequence"]
                                    linsidedict["dna_sequence_from_hmdm"] = json_data[modelID][
                                        "model_sequences"]["sequence"][seqinModel]["dna_sequence"]["sequence"]
                                    if "partial" in json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"].keys():
                                    ...
                                    if self.input_type == 'contig':
                                        ...
                                        linsidedict["orf_end"] = self.extract_nth_hash(
                                            orfInfo.decode(), 2)
                                        linsidedict["orf_from"] = self.extract_nth_hash(
                                            orfInfo.decode(), 0)
