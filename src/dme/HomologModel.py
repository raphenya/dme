...
class Homolog(BaseModel):
	...
	def run(self):
		...
		with open(os.path.join(self.data,"hmdm.json")) as json_file:
						...
						for hsp in alignment.hsps:
							...
							try:
								if card_sequence.upper() == orf_protein_sequence.upper():
									...
									ppinsidedict["HMDM_accession"] = json_data[modelID]["HMDM_accession"]
									ppinsidedict["HMDM_name"] = json_data[modelID]["HMDM_name"]
									ppinsidedict["HMDM_category"] = json_data[modelID]["HMDM_category"]
									ppinsidedict["evalue"] = hsp.expect
									ppinsidedict["bit_score"] = hsp.bits
									ppinsidedict["max_identities"] = hsp.identities
									ppinsidedict["positives"] = hsp.positives
									...
									ppinsidedict["sequence_from_hmdm"] = json_data[modelID]["model_sequences"]["sequence"][seqinModel]["protein_sequence"]["sequence"]
									ppinsidedict["dna_sequence_from_hmdm"] = json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"]["sequence"]
									...
									insidedict["HMDM_accession"] = json_data[modelID]["HMDM_accession"]
									insidedict["HMDM_name"] = json_data[modelID]["HMDM_name"]
									insidedict["HMDM_category"] = json_data[modelID]["HMDM_category"]
									insidedict["evalue"] = hsp.expect
									insidedict["bit_score"] = hsp.bits
									insidedict["max_identities"] = hsp.identities
									insidedict["positives"] = hsp.positives
									...
									insidedict["sequence_from_hmdm"] = json_data[modelID]["model_sequences"]["sequence"][seqinModel]["protein_sequence"]["sequence"]
									insidedict["dna_sequence_from_hmdm"] = json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"]["sequence"]
									if "partial" in json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"].keys():
									...
									linsidedict["HMDM_accession"] = json_data[modelID]["HMDM_accession"]
									linsidedict["HMDM_name"] = json_data[modelID]["HMDM_name"]
									linsidedict["HMDM_category"] = json_data[modelID]["HMDM_category"]
									linsidedict["evalue"] = hsp.expect
									linsidedict["max_identities"] = hsp.identities
									linsidedict["positives"] = hsp.positives
									...
									linsidedict["sequence_from_hmdm"] = json_data[modelID]["model_sequences"]["sequence"][seqinModel]["protein_sequence"]["sequence"]
									linsidedict["dna_sequence_from_hmdm"] = json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"]["sequence"]
									if "partial" in json_data[modelID]["model_sequences"]["sequence"][seqinModel]["dna_sequence"].keys():
